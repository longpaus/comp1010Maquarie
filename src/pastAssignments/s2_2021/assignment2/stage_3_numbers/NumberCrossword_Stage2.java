...
//Complete this (successfully) before moving to NumberCrossword_Stage3
public class NumberCrossword_Stage2 {
	public int[][] board;
	 ...
	 * @param n assume n > 0
	 */
	public NumberCrossword_Stage2(int n) {
		board = new int[n][n];
	 ...
	 */
	public NumberCrossword_Stage2(int[][] data) {
	 ...
	 * 
	 * @param target
	 * @return same as stage 1, except you can use addition or subtraction
	 * (in that order). first try to use addition, and only if not possible
	 * using addition, use subtraction
	 */
	...
	public static void main(String[] args) {
		...
		int[][] data = {{3, 5, 7, 5, 7}, 
				...
				{3, 9, 3, 9, 7},
				{4, 5, 7, 3, 3}};
		NumberCrossword_Stage2 c = new NumberCrossword_Stage2(data);
